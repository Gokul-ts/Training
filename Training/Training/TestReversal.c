...
void OutputCheck () {
   ...
   for (int i = 0; i < strLength; i++) {
      ...
      printf ("\n| %-28s | %-22s |   "ANSI_COLOR_GREEN"PASS"ANSI_RESET_ALL"   |"ANSI_COLOR_MAGENTA
              "\n--------------------------------------------------------------------"ANSI_RESET_ALL,
   ...
   for (int i = 0; i < numLength; i++) {
      ...
      printf ("\n| %-10d | %-10lld | %-22s |   "ANSI_COLOR_GREEN"PASS"ANSI_RESET_ALL"   |"ANSI_COLOR_MAGENTA
              "\n---------------------------------------------------------------"ANSI_RESET_ALL,
              numInput[i], revNum, numOutput);
   }
   printf ("\n\n");
}
